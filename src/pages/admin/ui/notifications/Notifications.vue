      ...
      <va-card-content class="flex flex-col gap-4">
        ...
        >
          <template #icon>
            <va-badge
              color="info"
              :text="t('notificationsPage.notifications.info')"
            />
          </template>
        ...
        >
          <template #icon>
            <va-badge
              color="warning"
              :text="t('notificationsPage.notifications.warning')"
            />
          </template>
        ...
        >
          <template #icon>
            <va-badge
              color="danger"
              :text="t('notificationsPage.notifications.danger')"
            />
          </template>
        ...
        >
          <template #icon>
            <va-badge
              color="gray"
              :text="t('notificationsPage.notifications.gray')"
            />
          </template>
          {{ t("notificationsPage.notifications.warningMessage") }}
        </va-alert>
        ...
        >
          <template #icon>
            <va-badge
              color="dark"
              :text="t('notificationsPage.notifications.dark')"
            />
          </template>
          {{ t("notificationsPage.notifications.dangerMessage") }}
        </va-alert>
