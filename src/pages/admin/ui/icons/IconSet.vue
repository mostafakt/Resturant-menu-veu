<template>
  <div class="icon-set">
    <va-card class="icon-set__header mb-8 pb-4">
      ...
      <va-card-content
        class="grid grid-cols-12 gap-6 items-start justify-between"
      >
        <va-button
        ...
        <div
          class="icon-set__header__size col-span-full md:col-span-5 flex items-center"
        >
          <span
            class="m-2 pr-2 icon-set__header__size--smaller"
          ...
          <span
            class="m-2 pl-2 icon-set__header__size--bigger"
            :style="{ color: colors.dark }"
            >A</span
          >
        </div>
